...
SELECT pg_catalog.setval('cdc.cdc_config_id_seq', 1, false);
...
SELECT pg_catalog.setval('dwh.dim_temps_temps_key_seq', 1, false);
...
SELECT pg_catalog.setval('monitoring.dwh_status_id_seq', 1, false);
