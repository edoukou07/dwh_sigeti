...
--
-- Name: vue_synthese_zones; Type: VIEW; Schema: dwh; Owner: postgres
--

CREATE VIEW dwh.vue_synthese_zones AS
 SELECT 'Synthese'::text AS type,
    count(*) AS total
   FROM dwh.dim_zones_industrielles;


ALTER TABLE dwh.vue_synthese_zones OWNER TO postgres;
...
1	zones_industrielles	dwh.dim_zones_industrielles	\N	INCREMENTAL	t	2025-10-26 13:34:35.143442
\.
...
1	1	Entreprise Test	\N	\N	\N	\N	\N	\N	\N	\N	2025-10-26 13:38:46.124296	2025-10-26 13:38:46.124296
\.
...
1	2025-10-26	2025	1	1	1	Janvier	Lundi	1	f	f	2025-10-26 13:34:33.905847
\.
...
1	1	Zone Test	Test Location	100.00	10	ACTIVE	2025-10-26	Admin	2025-10-26 13:34:34.115692	2025-10-26 13:34:34.115692
\.
...
1	dwh.dim_zones_industrielles	0	2025-10-26 13:34:35.775166	ACTIF	Table initialisee	2025-10-26 13:34:35.775166
\.
...
SELECT pg_catalog.setval('dwh.dim_entreprises_entreprise_key_seq', 1, true);
...
SELECT pg_catalog.setval('dwh.dim_zones_industrielles_zone_key_seq', 1, true);
